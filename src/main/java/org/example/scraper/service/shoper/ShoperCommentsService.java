...
public class ShoperCommentsService {
    private static final String ORDER_NOTE_URL_PREFIX = "https://applecentrum-612788.shoparena.pl/console/orders/changenotes/id/";
    private static final CookieManager cookieManager = CookieManager.getInstance();

    // Adds private note to order
    public static void writePrivateOrderNote(String orderId, String noteText) throws Exception {

        String url = ORDER_NOTE_URL_PREFIX + orderId + "/ispriv/1";
        ...
        Connection.Response response = Jsoup.connect(url)
                ...
                .header("Referer",
                        "https://applecentrum-612788.shoparena.pl/admin/orders/view/id/" + orderId)
        ...
        if (status == 200) {
            ...
            throw new Exception("Failed to add note to the order " + orderId + "! Status code: "
